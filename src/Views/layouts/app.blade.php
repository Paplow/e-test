...
<head>
    ...
    <title>@yield('title', config('app.name', 'e-Test'))</title>

    <!-- Styles -->
    <link href="{{ asset('vendor/e-test/css/e-test.css') }}" rel="stylesheet">
    ...
    <link href="{{ asset('vendor/e-test/css/style.css') }}" rel="stylesheet">
</head>
<body>
<div id="app">
...
<!-- Scripts -->
<script src="{{ asset('vendor/e-test/js/e-test.js') }}"></script>
@include('e-test::partials.sweetalert2')
@yield('scripts')
</body>
</html>
